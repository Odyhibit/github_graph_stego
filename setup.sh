...
echo "  2. (Optional) Edit config.json with your preferences"
echo "  3. Run encoder: python encoder.py \"Your message\" --start 2024-01-01 --dry-run"
echo "  4. Run tests: python -m unittest discover"
echo ""
